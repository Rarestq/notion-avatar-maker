    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow flex items-center justify-center">
        <div className="container mx-auto px-4 py-8 max-w-3xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-black">Privacy Policy for Notion-Avatar-Maker</h1>
          ...
          <div className="space-y-6 text-gray-600 text-justify">
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Collecting and Using Your Personal Data</h2>
            <h3 className="text-lg md:text-xl mb-2 text-black">Personal Data</h3>
            ...
            <h3 className="text-lg md:text-xl mb-2 text-black">Usage Data</h3>
            ...
            <h3 className="text-lg md:text-xl mb-2 text-black">Information from Third-Party Social Media Services</h3>
            ...
            <h3 className="text-lg md:text-xl mb-2 text-black">Tracking Technologies and Cookies</h3>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Purpose of Data Collection</h2>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Data Sharing</h2>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Delete Your Personal Data</h2>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Security of Your Personal Data</h2>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Children&apos;s Privacy</h2>
            ...
            <h2 className="text-xl md:text-2xl mb-4 text-black font-semibold">Updates to This Privacy Policy</h2>
