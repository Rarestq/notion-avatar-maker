    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="container mx-auto py-8 flex-grow">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 text-black" >Terms of Service for Notion-Avatar-Maker</h1>
          ...
          <h2 className="text-2xl mb-6 text-black">Content Liability</h2>
          ...
          <h2 className="text-2xl mb-6 text-black">Modifications</h2>
